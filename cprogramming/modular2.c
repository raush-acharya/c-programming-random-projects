...
int main()
{
	...
	int perimeter, area, length, breadth;  /*for perimeter and area of rectangle and circle*/
	...
	
	{
		...
		case 7:
			...
			printf("The curved surface area of cylinder having radius %d and height %d is : \t%d sq.units.", radius, height, area);
			break;
